...
public class MetricsUtils {
    ...
    /**
     * Jeffrey Divergence or Jensen-Shannon divergence (JSD) from Deselaers, T.; Keysers, D. & Ney, H. Features for image retrieval: an
     * experimental comparison Inf. Retr., Kluwer Academic Publishers, 2008, 11, 77-107
     *
     * @param h1
     * @param h2
     * @return
